...
<div class="card">
  ...
  <div class="card-body">
    ...
    <?php if(session('success')): ?>
      <div class="alert alert-success alert-flash">✅ <?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
      <div class="alert alert-error alert-flash">❌ <?php echo e(session('error')); ?></div>
    <?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
            <div class="field-err show"><?php echo e($message); ?></div>
          <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <p class="register-link">
      No account? <a href="<?php echo e(route('register')); ?>">Create one free</a>
    </p>
...
async function verifyOtp() {
  ...
  try {
    const res = await fetch('<?php echo e(route("auth.otp.verify")); ?>', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
</html><?php /**PATH C:\Users\User\Downloads\docbook1_final\docbook1\docbook1\resources\views/auth/login.blade.php ENDPATH**/ ?>