            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">
                        Current: <strong><?php echo e($profile?->max_patients_per_day ?? 30); ?></strong>
                        (booking type: <strong><?php echo e($profile?->booking_type ?? 'time'); ?></strong>)
                    </p>
                </div>
                        ...
                        <label class="flex items-center gap-3 cursor-pointer select-none mb-2">
                            <div class="relative">
                                ...
                                <input type="checkbox" name="allow_next_day" value="1"
                                    <?php echo e($profile?->allow_next_day ?? true ? 'checked' : ''); ?>
        ...
        <form method="POST" action="/doctor/settings/password" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" name="current_password" required placeholder="••••••••"
                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent <?php $__errorArgs = ['current_password'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="password" name="password" required placeholder="Min. 6 characters"
                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Downloads\docbook1_final\docbook1\docbook1\resources\views/doctor/settings.blade.php ENDPATH**/ ?>