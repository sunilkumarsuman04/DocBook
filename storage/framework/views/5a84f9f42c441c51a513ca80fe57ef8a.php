...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','Login'); ?> — DocBook</title>
...
<body class="min-h-screen flex antialiased bg-white" style="font-family:'Sora',sans-serif">
    ...
    <div class="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <?php $__currentLoopData = [280,420,560,700]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="absolute rounded-full border border-white/10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
             style="width:<?php echo e($s); ?>px;height:<?php echo e($s); ?>px"></div>
        ...
        <div class="relative">
            ...
            <div class="flex gap-8">
                <?php $__currentLoopData = [['500+','Doctors'],['50k+','Patients'],['4.8★','Rating']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$n,$l]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <p class="text-white font-bold text-xl"><?php echo e($n); ?></p>
                    <p class="text-brand-200 text-xs"><?php echo e($l); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php /**PATH C:\Users\User\Downloads\docbook1_final\docbook1\docbook1\resources\views/layouts/auth.blade.php ENDPATH**/ ?>