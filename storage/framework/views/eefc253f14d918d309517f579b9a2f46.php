...
<div>
    ...
    <div class="flex flex-col sm:flex-row gap-3 mb-6">
        <div class="flex gap-2 overflow-x-auto pb-1">
            ...
            <a href="?status=<?php echo e($s); ?>&search=<?php echo e(request('search')); ?>"
        ...
        <form method="GET" class="sm:ml-auto">
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search patient name…"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm min-w-[640px]">
                    <thead class="bg-slate-50 border-b border-slate-100">
                        <tr>
                            <?php $__currentLoopData = ['Patient','Doctor','Specialization','Date & Time','Fee','Status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="py-3.5 px-5 font-medium text-slate-900"><?php echo e($apt->patient->name); ?></td>
                            <td class="py-3.5 px-5 text-slate-600">Dr. <?php echo e($apt->doctor->name); ?></td>
                            <td class="py-3.5 px-5 text-slate-500"><?php echo e($apt->doctor->doctorProfile?->specialization ?: '—'); ?></td>
                            <td class="py-3.5 px-5">
                                <p class="text-slate-700 font-medium"><?php echo e($apt->appointment_date->format('M d, Y')); ?></p>
                                <p class="text-xs text-slate-400"><?php echo e(\App\Helpers\AppHelper::formatTime($apt->start_time)); ?></p>
                            </td>
                            <td class="py-3.5 px-5 text-slate-700">₹<?php echo e(number_format($apt->consultation_fee)); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Downloads\docbook1_final\docbook1\docbook1\resources\views/admin/appointments.blade.php ENDPATH**/ ?>