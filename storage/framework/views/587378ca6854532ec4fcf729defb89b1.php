...
<div>
    ...
    <div class="flex gap-2 overflow-x-auto pb-1 mb-6">
        ...
        <a href="?extra=1"
           class="flex-shrink-0 px-4 py-2 rounded-xl text-sm font-medium transition-colors
                  <?php echo e(request('extra') === '1' ? 'bg-orange-500 text-white' : 'bg-white border border-orange-200 text-orange-600 hover:bg-orange-50'); ?>">
            🔔 Extra Requests
        </a>
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm min-w-[750px]">
                    <thead class="bg-slate-50 border-b border-slate-100">
                        <tr>
                            <?php $__currentLoopData = ['Patient','Date','Token / Time','Note','Status','Actions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors <?php echo e($apt->is_extra_request && $apt->status === 'PENDING' ? 'bg-orange-50/60' : ''); ?>">
                            <td class="py-3.5 px-5">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <p class="font-semibold text-slate-900"><?php echo e($apt->patient->name); ?></p>
                                        <p class="text-[11px] text-slate-400"><?php echo e($apt->patient->email); ?></p>
                            ...
                            <td class="py-3.5 px-5 text-slate-600"><?php echo e($apt->appointment_date->format('M d, Y')); ?></td>
                            <td class="py-3.5 px-5 text-slate-600">
                                <?php if($apt->token_number): ?>
                                    <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-teal-100 text-teal-700">
                                        🎫 Token #<?php echo e($apt->token_number); ?>

                                    </span>
                                <?php elseif($apt->is_extra_request): ?>
                            ...
                            <td class="py-3.5 px-5">
                                <?php if($apt->patient_note): ?>
                                <p class="text-slate-500 text-xs max-w-[160px] truncate italic" title="<?php echo e($apt->patient_note); ?>">
                                    "<?php echo e($apt->patient_note); ?>"
                                </p>
                                <?php elseif($apt->notes): ?>
                                <p class="text-slate-400 text-xs max-w-[140px] truncate"><?php echo e($apt->notes); ?></p>
                                <?php else: ?>
                                <span class="text-slate-300">—</span>
                                <?php endif; ?>
                            </td>
                            <td class="py-3.5 px-5"><?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
                                ...
                                <div class="flex gap-1.5 flex-wrap">
                                    ...
                                    <form method="POST" action="/doctor/appointments/<?php echo e($apt->id); ?>/approve">
                                        ...
                                        <button class="text-xs px-2.5 py-1 bg-brand-100 text-brand-700 rounded-lg hover:bg-brand-200 font-medium transition-colors">
                                            <?php echo e($apt->is_extra_request ? '✓ Accept' : 'Confirm'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Downloads\docbook1_final\docbook1\docbook1\resources\views/doctor/appointments.blade.php ENDPATH**/ ?>