...
<div class="email-wrapper">
  ...
  <div class="body">
    ...
    <div class="detail-card">
      ...
      <div class="detail-row">
        ...
        <span class="detail-value">#{{ str_pad($appointmentId, 6, '0', STR_PAD_LEFT) }}</span>
      </div>
    ...
    <div class="cta-section">
      <a href="{{ config('app.url') }}/patient/appointments/{{ $appointmentId }}" class="btn">
        View Appointment
      </a>
    </div>
  ...
  <div class="footer">
    <p>
      This email was sent from <a href="{{ config('app.url') }}">DocBook</a> — Smart Healthcare Platform.<br/>
      © {{ date('Y') }} DocBook. All rights reserved.
    </p>
    <p style="margin-top: 8px;">
      <a href="{{ config('app.url') }}/patient/appointments">My Appointments</a>
      &nbsp;·&nbsp;
      <a href="{{ config('app.url') }}/contact">Help & Support</a>
    </p>
    <p style="margin-top: 8px; font-size: 11px; color: #cbd5e1;">
      Booking Reference: #{{ str_pad($appointmentId, 6, '0', STR_PAD_LEFT) }}
    </p>
  </div>
