...
<div class="email-wrapper">
  ...
  <div class="body">
    ...
    <p class="greeting" style="margin-top:8px;color:#475569;font-size:14px;">
      ...
      <strong>{{ \Carbon\Carbon::parse($appointmentDate)->format('l, d F Y') }}</strong>
    ...
    <div class="cta-section">
      <a href="{{ config('app.url') }}/patient/search" class="btn">Find Another Doctor</a>
    </div>
  ...
  <div class="footer">
    <p>This email was sent from <a href="{{ config('app.url') }}">DocBook</a> — Smart Healthcare Platform.<br/>
    © {{ date('Y') }} DocBook. All rights reserved.</p>
  </div>
</div>
</body>
</html>
